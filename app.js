...
(function () {
  ...
  const ROUTES = {
    ...
    'visa':{title:'Visa, Accreditation & Travel Documents',crumb:[{l:'Home',h:'#home'},{l:'Visa & Travel Documents',cur:true}],ref:'— DIPLOMATIC PROTOCOL · VISA',parent:null},
    ...
    'advisories':{title:'Advisories & Crisis Line',crumb:[{l:'Home',h:'#home'},{l:'Advisories',cur:true}],ref:'— ADVISORIES',parent:null},
